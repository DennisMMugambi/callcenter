...
import com.s.callcenter.Utils.UserUtils;
...
public class LoginActivity extends AppCompatActivity {
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            CallCenterInfoModel callCenterInfoModel = snapshot.getValue(CallCenterInfoModel.class);
                            goToHomeActivity(callCenterInfoModel);
                        } else {
                            showRegisterLayout();
                        }
                    }
    ...
    private void showRegisterLayout() {
        ...
        btn_continue.setOnClickListener(v -> {
            ...
            } else if(TextUtils.isEmpty(edt_phone_number.getText().toString()))
            {
                ...
                CallCenterInfoModel model = new CallCenterInfoModel();
    ...
    private void goToHomeActivity(CallCenterInfoModel technicianInfoModel) {
        Common.currentUser = technicianInfoModel;
        //delaySplashScreen();
        startActivity(new Intent(LoginActivity.this, CallCenterActivity.class));
        finish();
    }
                    ...
                    .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                Intent intent = new Intent(LoginActivity.this, CallCenterActivity.class);
