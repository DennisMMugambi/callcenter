...
public class SplashScreenActivity extends AppCompatActivity {
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            CallCenterInfoModel technicianInfoModel = snapshot.getValue(CallCenterInfoModel.class);
    ...
    private void goToHomeActivity(CallCenterInfoModel technicianInfoModel) {
        ...
        //delaySplashScreen();
        startActivity(new Intent(SplashScreenActivity.this, CallCenterActivity.class));
        finish();
    }
}