...
public class VerificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mResend.setOnClickListener(v -> {
            assert SignUpActivity.mUser != null;
            SignUpActivity.mUser.sendEmailVerification().addOnSuccessListener(aVoid -> Toast.makeText(getApplicationContext(),
    ...
    private void verifyemail() {
        ...
        if(user.isEmailVerified()){
            startActivity(new Intent(getApplicationContext(), CallCenterActivity.class));
        } else {
